    ...
    def feed_forward_generator(self, advantages, num_mini_batch):
        ...
        for indices in sampler:
            ...
            observations_batch_prime = self.observations[1:].view(-1,
                                        *self.observations.size()[2:])[indices]
            noisy_observations_batch = self.noisy_observations[:-1].view(-1,
                                                             *self.noisy_observations.size()[2:])[indices]
            true_observations_batch = self.true_observations[:-1].view(-1,
                                                                         *self.true_observations.size()[2:])[indices]
            ...
            yield observations_batch, states_batch, actions_batch, \
                ...
                observations_batch_prime, true_rewards_batch, noisy_observations_batch, \
                true_observations_batch
